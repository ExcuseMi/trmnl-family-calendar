...
const TRANSFORM_PATH = process.env.TRANSFORM_PATH || path.join(REPO_ROOT, 'plugin/src/transform.js');
...
// `<script src="../plugin/src/transform.js">` tag) so it can be eval'd directly into a jsdom
...
const SKELETON_HTML = EDITOR_HTML
  .replace(/<script src="\.\.\/plugin\/src\/transform\.js"><\/script>\s*/, '')
