...
module.exports = function (test, h) {
  ...
  const ICS = [
    ...
    'BEGIN:VEVENT', 'UID:1', 'SUMMARY:Kato swimming',
  ...
  const CONFIG = {
    ...
    lines: [{ name: 'Kato' }, { name: 'Nala' }],
    calendars: [{
      url: 'https://example.com/a.ics',
      rules: [
        { match: { type: 'and', matchers: [{ type: 'word', value: 'swim' }, { type: 'word', value: 'Kato' }] }, line: 'Kato' },
        { match: { type: 'word', value: 'family' }, line: ['Kato', 'Nala'] },
      ],
    }],
  };
