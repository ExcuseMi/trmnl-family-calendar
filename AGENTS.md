...
- **TRMNL X FULL VIEW IS THE TARGET.** That is the board to optimise: 1872x1404, classes `screen--v2 screen--lg screen--4bit screen--density-2x`, 1020x701 in layout px. The OG panel and the half and quadrant slots may crop tracks or the time span to fit; they are not the thing being designed for, and a board that packs there is not a reason to make the X board worse.
