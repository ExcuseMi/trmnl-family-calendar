...
* **Consent is asked for every time**, in the editor, with the exact links it
  would send listed, and whose server it is named. It is never a default and
  the answer is not remembered across a reload.
